...
Pagination - DbContext.Records.Skip(pageNumber * pageSize).Take(pageSize).ToList();
...
//         }
        ...
        //{
            ...
            // Console.WriteLine("Hello Sharanabasava...!");
            // Console.WriteLine("Sharanabasava age is : " +age);

            // Console.Write("Enter your input : ");
            // String inp = Console.ReadLine();
            // Console.WriteLine("User input is : " +inp);
            ...
            // Implicit casting
            // chat to int to long to float to double
            ...
            // int a = (int) 34.4 ;        // Double to Int
            // Console.WriteLine(a) ;

            // float b = Convert.ToInt32(35.5) ;    // Float to Int
            // Console.WriteLine(b) ;

            // string c = Convert.ToString(32);     // Char to String
            // Console.WriteLine(c) ;
            ...
            // Console.WriteLine("Okay you will get 4 more extra candy, " + (Convert.ToInt32(candy) + 4)) ;
            ...
            // int a = Math.Max(35, 450);
            // int a = Math.Min(35, 450);
            // double a = Math.Sqrt(36);
            // double a = Math.Round(34.67843);
            // Console.WriteLine(a);

            //// Strings

            // string str = "Hello Sharanabasava, How are you..?" ;
            // Console.WriteLine(str.Length) ;
            // Console.WriteLine(str.ToUpper()) ;
            // Console.WriteLine(str.ToLower()) ;
            // Console.WriteLine(str + " Where are you know..?") ;
            // Console.WriteLine(string.Concat(str, " Where are you know..?")) ;
            ...
            // Console.WriteLine(str.IndexOf("are"));
            ...
            // string str = "Hello Sharanabasava, \n  How are you..?" ;
            // Console.WriteLine(str);
            ...
            // else if(age < 10)
            // {
            //     Console.WriteLine("Please complete your primary school");

            // }
            // else if(age < 18)
            // {
            //     Console.WriteLine("Person below 18, cannot drive");
            ...
            // else
            // {
            //     Console.WriteLine("Person cannot Drive");
            // }
            ...
            //     if(i == 0)
            //     {
            //         continue;        // Leave this perticulat iteration of the loop
            //     }
            //     Console.WriteLine(i);
            // }
            ...
            /////   Metrhods OR Functions

            // Greet();        // Calling method directly
            // Greet();
            // Greet("Sharanu");
            // Greet("Bassu");

            // Console.Write(Average(2,8,6));
            ...
            // Player tommy = new Player();     // Object creation
